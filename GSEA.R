...
GSEA.EnrichmentScore <- function(gene.score, gene.set, weighted.score.type = 1) {  
  #
  # Computes the weighted GSEA score of gene.set with gene.score 
  ...
  #
  # Inputs:
  #   gene.score: gene scores associated with coditions. 
  #   gene.set: list of gene sets
